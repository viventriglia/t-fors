...
FEAT_NAMES_DICT = {
    ...
    "Auroral electrojet (IE) moving averages": "IE exponential moving averages within 3-, 6-, 12- and 24-hours window",
    ...
    "Auroral electrojet (IU) moving averages": "IU exponential moving averages within 3-, 6-, 12- and 24-hours window",
...
OUTP_NAMES_DICT = {
    ...
    "Max F1-score prediction": "Binary output of the model with decision threshold set to 0.63 (cross-validated F1-score: 0.57)",
    "High-precision prediction": "Binary output of the model with decision threshold set to 0.84 (cross-validated F1-score: 0.50), in order to achieve 80%-level precision",
    "High-recall prediction": "Binary output of the model with decision threshold set to 0.53 (cross-validated F1-score: 0.56), in order to achieve 60%-level recall",
}
